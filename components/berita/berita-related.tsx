...
export function BeritaRelated({ relatedArticles }: { relatedArticles: RelatedArticle[] }) {
  // Animation variants for related articles
  const container = {
    hidden: { opacity: 0 },
    show: {
      opacity: 1,
  ...
  return (
    <section className="py-12 px-4 bg-white border-t border-border/10">
